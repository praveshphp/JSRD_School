            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="input-group search-area right d-lg-inline-flex d-none">
                        <input type="text" class="form-control" placeholder="Find something here..." id="autosuggest-property">
                ...
                <ul class="navbar-nav header-right main-notification">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link  ai-icon d-none" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50"
                                                    src="{{ URL::asset('/images/avatar/1.jpg') }}">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">                           
                                <img src="{{ URL::asset('/images/BT.png') }}" alt="" width="20">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">                            
                            ...
                            document.getElementById('logout-form').submit();">
                                <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class=""
