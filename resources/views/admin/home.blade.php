...
@endsection
@push('js')
    <script src="https://cdn.jsdelivr.net/gh/suchg/google.map_markers_multi@master/jquery.ajaxQueue.js"></script>
    <script src="https://unpkg.com/@googlemaps/markerclusterer/dist/index.min.js"></script>
    <script src="{{ asset('vendor/chart.js/Chart.bundle.min.js') }}"></script>
    <script src="{{ asset('vendor/peity/jquery.peity.min.js') }}"></script>
    <!--<script src="{{ asset('vendor/apexchart/apexchart.js') }}"></script>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <script src="{{ asset('js/dashboard/dashboard-1.js') }}"></script>-->
    <script src="{{ asset('js/map-skin.js') }}"></script>
    <script src="{{ asset('vendor/owl-carousel/owl.carousel.js') }}"></script>
    <script src="{{ asset('vendor/select2/js/select2.full.min.js') }}"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key={{ config('app.google_map_key') }}&callback=initMap&v=weekly"
        defer></script>
 


    <script src="{{ asset('js/map.js') }}"></script>
    <!--<script src="{{ asset('js/us_state.js') }}"></script>-->
